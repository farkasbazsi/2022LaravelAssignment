...
<div class="container">
    ...
    <form action="{{ route('items.store') }}" method="POST">
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-sm-10">
                <textarea rows="5" class="form-control @error('description') is-invalid
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-sm-10">
                <input class="@error('obtained') is-invalid
                @enderror" type="date" id="obtained" name="obtained" value="2022-11-13"
                    min="2001-01-08" max="2022-11-13">
            </div>
            @error('obtained')
                    <div class="invalid-feedback">
                        {{ $message }}
